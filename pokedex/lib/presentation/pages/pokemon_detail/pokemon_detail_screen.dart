...
import 'package:pokedex/presentation/widgets/detail_header.dart';
import 'package:pokedex/presentation/widgets/shape_info.dart';
        ...
        builder: (context, ref, child) {
          ...
          return FloatingActionButton.extended(
            label: Text(
              ...
              style: TextStyle(
                  color:
                      isFavourite ? ColorConstants.blue : Colors.white),
            ),
        ...
        slivers: <Widget>[
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                PokemonDetailHeader(pokemonDetailEntity: widget.pokemonDetailEntity),
                PokemonShapeInfo(pokemonDetailEntity: widget.pokemonDetailEntity),
                PokemonStatWidget(pokemonDetailEntity: widget.pokemonDetailEntity,
                )
              ],
            ),
          ),
